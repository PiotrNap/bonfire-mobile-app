...
export const FAILED_CREDENTIALS_DELETION_MSG =
...
export const FAILED_ACCOUNT_DELETION_MSG =
  "We were unable to deactivate your account in our database. Please try again. If the problem persists please contact our support."
