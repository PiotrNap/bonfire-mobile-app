...
import { MintingPolicyHash, PubKeyHash, TxId, TxInput, Value } from "@helios-lang/ledger"
...
export const escrow_contract = {
    ...
    >(
      {
        ...
        variantTypes: [
            ...
            fieldTypes: [
              {
                ...
                type: {
                  ...
                  itemType: {
                    kind: "struct",
                    format: "list",
                    id: "__module__escrow_contract__TxOutId[]",
                    name: "TxOutId",
                    fieldTypes: [
                      { name: "txId", type: { kind: "internal", name: "TxId" } },
                      { name: "utxoIdx", type: { kind: "internal", name: "Int" } },
          ...
          },
          {
            kind: "variant",
            tag: 2,
            id: "__module__escrow_contract__Redeemer[]__Recycle",
            name: "Recycle",
            fieldTypes: [],
          },
        ],
  ...
  $Datum: (config: CastConfig) =>
    new Cast<
      ...
      {
        beneficiaryPkh: PubKeyHash | string | number[]
        benefactorPkh: PubKeyHash | string | number[]
        releaseDate: TimeLike
        cancelFee: IntLike
    ...
    >(
      {
        kind: "struct",
        format: "list",
        id: "__module__escrow_contract__Datum[]",
        name: "Datum",
        fieldTypes: [
          { name: "beneficiaryPkh", type: { kind: "internal", name: "PubKeyHash" } },
          { name: "benefactorPkh", type: { kind: "internal", name: "PubKeyHash" } },
          { name: "releaseDate", type: { kind: "internal", name: "Time" } },
          { name: "cancelFee", type: { kind: "internal", name: "Int" } },
          { name: "cancelWindowStart", type: { kind: "internal", name: "Time" } },
          { name: "cancelWindowEnd", type: { kind: "internal", name: "Time" } },
          { name: "createdAt", type: { kind: "internal", name: "Time" } },
          { name: "paymentTokens", type: { kind: "internal", name: "String" } },
        ],
      },
      config
    ),
  $types: {
    ...
    TxOutId: (config: CastConfig) =>
      new Cast<
        { txId: TxId; utxoIdx: bigint },
        { txId: TxId | string | number[]; utxoIdx: IntLike }
      >(
        {
          kind: "struct",
          format: "list",
  ...
  $functions: {
    TREASURY_PKH: (uplc: UplcProgram, config: CastConfig) =>
      new UserFunc<{}, number[]>(uplc, {
        ...{
          name: "TREASURY_PKH",
          requiresCurrentScript: false,
          requiresScriptContext: false,
          arguments: [],
          returns: { kind: "internal", name: "ByteArray" },
        },
        castConfig: config,
        validatorIndices: __validatorIndices,
      }),
    treasuryPkh: (uplc: UplcProgram, config: CastConfig) =>
      new UserFunc<{}, PubKeyHash>(uplc, {
        ...{
          name: "treasuryPkh",
          requiresCurrentScript: false,
          requiresScriptContext: false,
          arguments: [],
          returns: { kind: "internal", name: "PubKeyHash" },
        },
        castConfig: config,
        validatorIndices: __validatorIndices,
      }),
    BETA_TESTER_MPH: (uplc: UplcProgram, config: CastConfig) =>
      new UserFunc<{}, number[]>(uplc, {
        ...{
          name: "BETA_TESTER_MPH",
          requiresCurrentScript: false,
          requiresScriptContext: false,
          arguments: [],
          returns: { kind: "internal", name: "ByteArray" },
    ...
    betaTesterMph: (uplc: UplcProgram, config: CastConfig) =>
      new UserFunc<{}, MintingPolicyHash>(uplc, {
        ...{
          name: "betaTesterMph",
          requiresCurrentScript: false,
          requiresScriptContext: false,
          arguments: [],
          returns: { kind: "internal", name: "MintingPolicyHash" },
        },
        castConfig: config,
        validatorIndices: __validatorIndices,
      }),
    minServiceFeePercent: (uplc: UplcProgram, config: CastConfig) =>
      new UserFunc<{}, bigint>(uplc, {
        ...{
          name: "minServiceFeePercent",
          requiresCurrentScript: false,
          requiresScriptContext: false,
          arguments: [],
          returns: { kind: "internal", name: "Int" },
        },
        castConfig: config,
        validatorIndices: __validatorIndices,
      }),
    minServiceFeeLovelace: (uplc: UplcProgram, config: CastConfig) =>
      new UserFunc<{}, bigint>(uplc, {
        ...{
          name: "minServiceFeeLovelace",
          requiresCurrentScript: false,
          requiresScriptContext: false,
          arguments: [],
          returns: { kind: "internal", name: "Int" },
    ...
    getServiceFeeAmnt: (uplc: UplcProgram, config: CastConfig) =>
      new UserFunc<{ lovelacePayout: IntLike; withBetaTesterToken: boolean }, Value>(
        uplc,
        {
          ...{
            name: "getServiceFeeAmnt",
            requiresCurrentScript: false,
            requiresScriptContext: false,
            arguments: [
              {
              ...
              {
                name: "withBetaTesterToken",
                isOptional: false,
                type: { kind: "internal", name: "Bool" },
              },
            ],
            returns: { kind: "internal", name: "Value" },
          },
          castConfig: config,
          validatorIndices: __validatorIndices,
        }
      ),
    checkInputForBetaTesterToken: (uplc: UplcProgram, config: CastConfig) =>
      new UserFunc<{ txIn: TxInput }, boolean>(uplc, {
        ...{
          name: "checkInputForBetaTesterToken",
          requiresCurrentScript: false,
          requiresScriptContext: false,
          arguments: [
            {
              name: "txIn",
              isOptional: false,
              type: { kind: "internal", name: "TxInput" },
            },
          ],
          returns: { kind: "internal", name: "Bool" },
        },
        castConfig: config,
        validatorIndices: __validatorIndices,
      }),
...
const __validatorIndices: Record<string, number> = { escrow_contract: 0 }
